...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Page.sub_heading'
        db.alter_column('surveymonkey_page', 'sub_heading', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Page.sub_heading'
        raise RuntimeError("Cannot reverse this migration. 'Page.sub_heading' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Page.sub_heading'
        db.alter_column('surveymonkey_page', 'sub_heading', self.gf('django.db.models.fields.CharField')(max_length=255))
